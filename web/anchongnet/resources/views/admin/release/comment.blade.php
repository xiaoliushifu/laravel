						...
						<div class="box-body">
							<table id="example1" class="table table-bordered table-striped">
								...
								<tr>
									...
									<td align="center">
										<button type='button' class='reply btn btn-primary btn-xs' data-id="{{$data['comid']}}" data-toggle="modal" data-target="#myModal" data-comname="{{$data['name']}}">回复</button>
										<button type="button" class="del btn btn-danger btn-xs" data-id="{{$data['comid']}}">删除</button>
									</td>
								</tr>  
								@endforeach
								<tr>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form role="form" class="form-horizontal" action="/reply" method="post" id="replyform">
						...
						<input type="hidden" name="chat" value="{{$_REQUEST['chat']}}">
