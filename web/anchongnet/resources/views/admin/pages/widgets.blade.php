            ...
            <div class="box-body">
              ...
              <div class="direct-chat-messages">
                ...
                <div class="direct-chat-msg">
                  ...
                  <!-- /.direct-chat-info -->
                  <img class="direct-chat-img" src="/admin/dist/img/user1-128x128.jpg" alt="Message User Image"><!-- /.direct-chat-img -->
                ...
                <div class="direct-chat-msg right">
                  ...
                  <!-- /.direct-chat-info -->
                  <img class="direct-chat-img" src="/admin/dist/img/user3-128x128.jpg" alt="Message User Image"><!-- /.direct-chat-img -->
                  <div class="direct-chat-text">
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          ...
          <div class="box box-widget widget-user">
            ...
            <div class="widget-user-image">
              <img class="img-circle" src="/admin/dist/img/user1-128x128.jpg" alt="User Avatar">
            </div>
            <div class="box-footer">
              <div class="row">
        ...
        <div class="col-md-4">
          ...
          <div class="box box-widget widget-user">
            <!-- Add the bg color to the header using any of the bg-* classes -->
            <div class="widget-user-header bg-black" style="background: url('/admin/dist/img/photo1.png') center center;">
              <h3 class="widget-user-username">Elizabeth Pierce</h3>
              <h5 class="widget-user-desc">Web Designer</h5>
            </div>
            <div class="widget-user-image">
              <img class="img-circle" src="/admin/dist/img/user3-128x128.jpg" alt="User Avatar">
            </div>
            <div class="box-footer">
              <div class="row">
                <div class="col-sm-4 border-right">
          ...
          <div class="box box-widget">
            ...
            <div class="box-body">
              ...
              <div class="attachment-block clearfix">
                <img class="attachment-img" src="/admin/dist/img/photo1.png" alt="Attachment Image">
            ...
            <div class="box-footer box-comments">
              ...
              <div class="box-comment">
                <!-- User image -->
                <img class="img-circle img-sm" src="/admin/dist/img/user5-128x128.jpg" alt="User Image">
