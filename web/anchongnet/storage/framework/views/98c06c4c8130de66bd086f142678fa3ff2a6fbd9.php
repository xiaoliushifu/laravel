...
<<<<<<< HEAD
=======
                                            <button type="button" class="advert f-ib btn btn-warning btn-xs" data-id="<?php echo e($data['gid']); ?>" data-gid="<?php echo e($data['goods_id']); ?>" data-toggle="modal" data-target="#myAdvert"
                                            data-name="<?php echo e($data['title']); ?>"
                                            data-num="<?php echo e($data['goods_numbering']); ?>">广告</button>

                                            <!-- Split button -->
                                            <!-- <div class="btn-group">
                                              <button type="button" class="btn btn-warning btn-xs" data-id="<?php echo e($data['gid']); ?>" data-gid="<?php echo e($data['goods_id']); ?>">广告</button>
                                              <button type="button" class="btn btn-warning dropdown-toggle btn-xs" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-id="<?php echo e($data['gid']); ?>" data-gid="<?php echo e($data['goods_id']); ?>">
