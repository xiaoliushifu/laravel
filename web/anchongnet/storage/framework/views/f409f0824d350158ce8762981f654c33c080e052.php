								...
								<?php foreach($datacol['datas'] as $data): ?>
									<tr>
										...
										<td align="center">
											...
											<?php if($data['state'] == 2): ?>
												<button type='button' class='f-ib shipbtn btn btn-primary btn-xs' data-id="<?php echo e($data['order_id']); ?>" data-num="<?php echo e($data['order_num']); ?>" data-toggle="modal" data-target="#mySend">发货</button>
											<?php elseif($data['state']==4): ?>
												<button type='button' class='check f-ib btn btn-primary btn-xs' data-id="<?php echo e($data['order_id']); ?>" data-num="<?php echo e($data['order_num']); ?>" data-toggle="modal" data-target="#myCheck">审核</button>
											<?php else: ?>
											<?php endif; ?>
										</td>
									</tr>
