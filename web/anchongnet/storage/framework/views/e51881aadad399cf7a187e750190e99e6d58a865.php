        ...
        <section class="content">
            <div class="row">
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-body">
                            <form action="/goodcatetype" method="get" class="form-horizontal form-inline f-ib">
                                <input type="text" name="keyName" value="<?php echo e($datacol['args']['keyName']); ?>" class="form-control" placeholder="分类名称">
                                <button type="submit" class="btn btn-primary btn-sm" id="filter">筛选</button>
                            </form>
                            <a href="/goodcatetype" class="btn btn-default btn-sm unplay f-ib" role="button">取消筛选</a>
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <?php foreach($datacol['datas'] as $data): ?>
                                    <tr>
                                        ...
                                        <td align="center">
                                            <img src="<?php echo e($data['pic']); ?>" width="50">
                                        </td>
                                        <td align="center">
                                            <button type='button' class='edit f-ib btn btn-primary btn-xs' data-id="<?php echo e($data['cid']); ?>" data-pid="<?php echo e($data['parent_id']); ?>" data-toggle="modal" data-target="#myModal">编辑</button>
                                            <button type="button" class="del f-ib btn btn-danger btn-xs" data-id="<?php echo e($data['cid']); ?>">删除</button>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                                <tr>
...
<script src="/admin/js/catetype.js"></script>
</body>
</html>
